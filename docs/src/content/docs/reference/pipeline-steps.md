...
Each configured or planned command attempt retains one complete immutable output file, including a real zero-byte file when the command emits no output.
