...
- Do not hand-edit `CHANGELOG.md` or `.release-please-manifest.json`. The generated-file guard accepts them only when the PR carries their exact tree entries from one release-only commit on canonical upstream `main`.
