...
func (m Model) View() string {
	...
	actionBar := renderActionBar(m.steps, refreshStrategy, showSelectionActions, allowFix, m.showDiff, selectedCount, totalCount, m.confirmAbort, hasDiff, approvalReady, retryAvailable)
