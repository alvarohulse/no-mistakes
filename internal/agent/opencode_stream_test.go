...
func TestParseOpencodeSSE_MarksSubagentWorkForCoverage(t *testing.T) {
...
`
	...
	if !state.subagentWorkObserved {
		t.Fatal("task tool did not mark subagent work for usage coverage")
	}
}
